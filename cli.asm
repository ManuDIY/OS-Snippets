; This version pauses after exiting *all* programs. Not just BASIC ones.
; Makes it possible to actually read the text output of CLI programs when they are called from the TUI.
; Might be controversial as a lot of programs (e.g. edit.bin) do not actually need this.
; BASIC and Binary programs now use the same message.
